...
class JhipsterMono20210222KafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterMono20210222KafkaResource kafkaResource = new JhipsterMono20210222KafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-mono-20210222-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-mono-20210222-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
