...
@RestController
@RequestMapping("/api/jhipster-mono-20210222-kafka")
public class JhipsterMono20210222KafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhipsterMono20210222KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterMono20210222KafkaResource(KafkaProperties kafkaProperties) {
